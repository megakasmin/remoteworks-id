        ...
        content={{
          en: (
            <section className="space-y-12">
              ...
              <p className="text-lg text-gray-700">
                Your safety matters to us. RemoteWorks ID is designed to help
                professionals discover job opportunities while minimizing
                exposure to scams and misleading listings.
              </p>
              ...
              <div className="space-y-6">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    Clear separation between job discovery and hiring decisions
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    Always apply through official company websites or platforms
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                ...
                <p>
                  If you encounter a suspicious listing or employer behavior,
                  please contact us at{" "}
                  <strong>support@remoteworksid.com</strong>. We actively
                  investigate reports to keep the platform safe.
                </p>
              </div>

              <p className="text-sm text-gray-600">
                RemoteWorks ID does not act as an employer or recruiter and does
          ...
          id: (
            <section className="space-y-12">
              ...
              <p className="text-lg text-gray-700">
                Keamanan pengguna adalah prioritas kami. RemoteWorks ID membantu
                profesional menemukan peluang kerja sambil meminimalkan risiko
                penipuan.
              </p>
              ...
              <div className="space-y-6">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    Tidak mewajibkan komunikasi di luar kanal resmi
                  </li>
                  <li>
                    Pemisahan jelas antara platform dan keputusan rekrutmen
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    Selalu melamar melalui situs resmi perusahaan
                  </li>
                  <li>
                    Waspadai penawaran yang terlalu bagus
                  </li>
                  <li>
                    Jangan pernah membayar untuk melamar kerja
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  <strong>support@remoteworksid.com</strong>. Tim kami akan
                  menindaklanjuti setiap laporan.
                </p>
              </div>

              <p className="text-sm text-gray-600">
                RemoteWorks ID bukan pemberi kerja dan tidak menjamin hasil
                perekrutan.
              </p>
            </section>
          ),
